...
const TestimonialCarousel = () => {
  const testimonials = [
    ...
    { 
      ...
      exam: "GRE", 
      score: "335", 
      quote: "I was struggling with the Quantitative section, but STUDYSTREAK's GRE course changed the game for me. Their practice questions were invaluable." 
    },
    { 
      name: "Alex Johnson", 
      exam: "GMAT", 
      ...
      >
        {[...testimonials, ...testimonials].map((testimonial, index) => (
          <div key={index} className="w-[300px] flex-shrink-0 mx-3">
            <div className="bg-white p-6 rounded-xl shadow-card hover:shadow-card-hover 
...
const CourseDetailPage = () => {
  ...
  const [openSection, setOpenSection] = useState('Section 1: Introduction to IELTS');
    ...
    curriculum: [
      {
        ...
        lessons: ['Lesson 1 - What is the IELTS?', 'Lesson 2 - Understanding IELTS Format']
      },
      {
        title: 'Section 2: Listening Skills',
        lessons: ['Lesson 1 - Basic Listening Strategies', 'Lesson 2 - Practice Tests']
      }
    ]
  };
  ...
  return (
    <div className="bg-neutral-50 min-h-screen relative">
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button className="bg-primary-600 text-white px-8 py-3 rounded-xl
          hover:bg-primary-700 transition-all duration-300 text-lg font-semibold
          shadow-elevated hover:shadow-hover transform hover:-translate-y-0.5">
          Enroll Now
        </button>
      </div>
        ...
        <div className="absolute inset-0 flex flex-col justify-center">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <div className="text-primary-100 mb-4 inline-flex items-center 
                bg-primary-800/30 rounded-full px-4 py-1">
                {course.category}
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">{course.title}</h1>
              <p className="text-primary-100 text-lg mb-8 max-w-2xl">{course.description}</p>
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center text-white">
                  <Clock size={20} className="mr-2" />
                  <span>Duration: {course.startDate} - {course.endDate}</span>
                </div>
                <div className="flex items-center text-white">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-card border border-neutral-200 p-8 mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 mb-8">Course Details</h2>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {course.batchTimes.map((time, index) => (
                      <span key={index} className="bg-accent-50 text-accent-600 px-3 py-1 rounded-lg text-sm">
                        {time}
                      </span>
                    ))}
                  </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-800 font-medium">{course.startDate} - {course.endDate}</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-800 font-medium">{course.batchType}</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-800 font-medium">{course.language}</p>
                </div>
              </div>
            </div>
          </div>
...
{/* Packages Section */}
<div className="mb-12">
  <h2 className="text-2xl font-heading font-bold text-neutral-800 mb-8">Choose Your Package</h2>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      >
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {pkg.hasLiveClasses && (
              <div className="inline-flex items-center gap-1.5 bg-success-100 text-success-700 
            ...
            {pkg.hasPracticeTest && (
              <div className="inline-flex items-center gap-1.5 bg-info-100 text-info-700 
                px-3 py-1 rounded-full text-sm font-medium">
                <CheckCircle size={14} />
                Free Practice Test
              </div>
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="w-full bg-neutral-200 rounded-full h-1.5">
                    <div 
                      ...
                      style={{ 
                        width: `${Math.max((parseInt(number) / 10) * 100, 10)}%` 
                      }}
                    />
                  </div>
                </div>
        ...
        >
          {selectedPackage === index ? 'Selected Package' : 'Select Package'}
        </button>
        ...
        {/* Curriculum Section */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 mb-8">Course Curriculum</h2>
              ...
              <div key={index} className="border-b border-neutral-200 last:border-b-0">
                ...
                >
                  <div className="flex items-center">
                    <div className={`w-8 h-8 rounded-lg mr-4 flex items-center justify-center
                      ${openSection === section.title ? 'bg-primary-100 text-primary-600' : 'bg-neutral-100 text-neutral-600'}`}>
                      {index + 1}
                    </div>
                  ...
                  {openSection === section.title ? 
                    <ChevronUp className={`w-5 h-5 transform transition-transform duration-300 
                      ${openSection === section.title ? 'text-primary-600' : 'text-neutral-400'}`} /> : 
        ...
        {/* Related Courses */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-800 mb-8">Related Courses</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {relatedCourses.map((course, index) => (
              <div key={index} 
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-neutral-800 mb-3 group-hover:text-primary-600 
                    transition-colors duration-300">{course.title}</h3>
                    ...
                    <div className="flex mr-2">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i} 
                          size={16} 
                          className={`${i < Math.floor(course.rating) ? 'text-warning-400 fill-current' : 'text-neutral-200'}`}
                        />
                      ))}
                    </div>
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-neutral-100">
                    ...
                    <button className="bg-primary-50 text-primary-600 px-4 py-2 rounded-xl
          ...
          <div className="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="max-w-2xl mx-auto text-center">
                <h2 className="text-2xl font-bold text-white mb-4">Register for Free Webinar</h2>
                <p className="text-primary-100 mb-8">
                  Join our free webinar to learn more about IELTS preparation strategies and tips.
                </p>
                ...
                <form className="flex flex-col md:flex-row gap-4">
                  ...
                  <input 
                    type="email" 
                    placeholder="Your Email" className="flex-grow px-4 py-3 rounded-xl bg-white/10 text-white placeholder-primary-200
                    border border-primary-400 focus:border-white focus:ring-2 focus:ring-white/20
                    transition-all duration-300"
                  />
                  <button className="bg-white text-primary-600 px-8 py-3 rounded-xl font-medium
