...
// Inside IELTSCoursePage.js, add this component before the main component
...
const EnglishTest = () => {
    ...
    const questions = [
        ...
        },
        {
          ...
          correct: 1,
          explanation: "Future perfect tense is used for actions that will be completed by a specific time in the future.",
          category: 'Tenses'
        },
        ...
        // Reading Comprehension
        {
          ...
          correct: 1,
          explanation: "The passage presents both benefits and concerns about AI, showing a balanced perspective.",
          category: 'Main Idea'
        },
        ...
        // Writing Assessment
        {
          id: 7,
          type: 'writing',
          question: "Choose the most appropriate topic sentence for a paragraph about climate change:",
          options: [
          ...
          correct: 2,
          explanation: "A good topic sentence should be specific, clear, and academic in tone.",
        ...
        // Error Correction
        {
          id: 8,
          type: 'grammar',
          question: "Identify the error in this sentence: 'Neither the students or the teacher was present.'",
          options: [
            "Use of 'was'",
        ...
        // Prepositions
        {
          id: 9,
          type: 'grammar',
          question: "Choose the correct preposition: 'She is committed _____ achieving her goals.'",
        ...
        // Academic Vocabulary
        {
          id: 10,
          type: 'vocabulary',
          question: "Which word best completes this academic sentence: 'The research findings _____ previous studies on this topic.'",
          options: ["corroborate", "agree with", "say the same as", "match"],
          correct: 0,
          explanation: "'Corroborate' is the most academic choice to express agreement with previous research.",
        ...
        // Articles
        {
          id: 11,
          type: 'grammar',
          question: "Choose the correct article to complete the sentence: 'She is _____ honest person.'",
        ...
        // Reading Comprehension - Detail
        {
          ...
          correct: 1,
          explanation: "A solar eclipse occurs when the moon passes between the Earth and the sun.",
          category: 'Detail'
        },
        ...
        // Passive Voice
        {
          id: 16,
          type: 'grammar',
          question: "Change the sentence to passive voice: 'The chef cooks the meal.'",
          options: [
          ...
          correct: 0,
          explanation: "In passive voice, the object becomes the subject: 'The meal is cooked by the chef.'",
        ...
        // Writing Assessment - Thesis Statement
        {
          id: 18,
          type: 'writing',
          question: "Which of the following is the best thesis statement for an essay on renewable energy?",
          options: [
          ...
          correct: 2,
          explanation: "A good thesis statement is specific and outlines the main points.",
        ...
        // Conditionals
        {
          id: 20,
          type: 'grammar',
          question: "Choose the correct conditional form: 'If it rains tomorrow, we _____ cancel the picnic.'",
          options: ["would", "will", "had", "have"],
          correct: 1,
          explanation: "First conditional uses 'will' to express future possibility.",
          category: 'Conditionals'
        },
        ...
        // Collocations
        {
          id: 21,
          type: 'vocabulary',
          question: "Select the correct collocation: 'She _____ a degree in engineering.'",
        ...
        // Reading Comprehension - Inference
        {
          ...
          correct: 0,
          explanation: "Since he got soaked and left his umbrella, we can infer it was raining.",
          category: 'Inference'
        },
        ...
        // Tenses
        {
          id: 23,
          type: 'grammar',
          question: "Choose the correct tense: 'I _____ my homework before dinner last night.'",
        ...
        // Prepositions
        {
          id: 25,
          type: 'grammar',
          question: "Choose the correct preposition: 'He is interested _____ learning Spanish.'",
        ...
        // Word Stress
        {
          id: 26,
          type: 'listening',
          question: "Identify the correct stress pattern for the word 'development':",
          options: [
            "de-VE-lop-ment",
            "de-ve-LOP-ment",
            "de-ve-lop-MENT",
        ...
        // Writing Assessment - Conclusion Sentences
        {
          id: 27,
          type: 'writing',
          question: "Which sentence is most appropriate for concluding a paragraph on the benefits of exercise?",
          options: [
            "Exercise is good.",
          ...
          correct: 1,
          explanation: "A good conclusion summarizes the main points and reinforces the topic.",
        ...
        // Reported Speech
        {
          id: 28,
          type: 'grammar',
          question: "Choose the correct reported speech: 'She said, \"I am studying.\"'",
          options: [
          ...
          correct: 1,
          explanation: "In reported speech, present continuous becomes past continuous.",
        ...
        // Academic Vocabulary
        {
          id: 29,
          type: 'vocabulary',
          question: "Which word best completes this sentence: 'The data _____ that there is a correlation between diet and health.'",
          options: ["shows", "indicates", "says", "tells"],
          correct: 1,
          explanation: "'Indicates' is an appropriate academic verb in this context.",
          category: 'Academic Vocabulary'
        },
        ...
        // Error Correction
        {
          id: 30,
          type: 'grammar',
          question: "Identify the error in this sentence: 'Each of the students have finished their homework.'",
          options: [
            "Use of 'have'",
            "Use of 'their'",
            "Use of 'students'",
    ...
    const getRecommendation = (score) => {
      if (score >= 80) return "You have a strong foundation in English! Consider our Advanced IELTS course.";
      if (score >= 60) return "You're on the right track! Our Intermediate IELTS course would be perfect for you.";
      ...
      <div className="bg-white rounded-2xl shadow-card p-8">
        ...
        {!showResult ? (
                ...
                {questions[currentQuestion].options.map((option, index) => (
                  ...
                  >
                    <span className="inline-block w-6 h-6 rounded-full bg-white 
                      border-2 border-neutral-300 mr-3 text-center text-sm
          ...
          <div className="text-center">
            <div className="w-40 h-40 mx-auto mb-6 rounded-full bg-primary-50 
              flex items-center justify-center border-8 border-primary-100">
              <div>
