    ...
    <div className="container mx-auto px-4">
      <div className="flex justify-between items-center text-sm">
        <div className="flex items-center gap-4">
          <span>📧 info@studystreak.com</span>
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <div className="relative group">
            <input 
              ...
              className="w-48 pl-9 pr-4 py-2 rounded-xl border border-neutral-200 
                focus:ring-2 focus:ring-primary-300 focus:border-primary-300 focus:w-64
                bg-neutral-50 text-sm transition-all duration-300"
            />
            <Search 
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-heading font-bold">About STUDYSTREAK</h3>
              <p className="text-neutral-400 leading-relaxed">
                Empowering students worldwide to achieve their academic goals through 
                expert-led courses and innovative learning techniques.
              </p>
            </div>

            {/* Exams */}
            <div className="space-y-4">
              <h3 className="text-xl font-heading font-bold">Exams We Cover</h3>
              <ul className="space-y-3">
                {['IELTS', 'GRE', 'GMAT', 'TOEFL', 'PTE Academic'].map((exam, index) => (
                  <li key={index}>
                    <Link 
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4 pt-4">
                {['facebook', 'twitter', 'linkedin'].map((social, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-neutral-800 flex items-center 
