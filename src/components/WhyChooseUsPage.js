  ...
  const keyFeatures = [
    {
      ...
      description: "Learn from certified IELTS trainers with proven track records of helping students achieve band 8+",
      icon: Users,
      color: "primary"
    },
    {
      title: "Comprehensive Study Material",
      description: "Access our extensive library of practice tests, study guides, and mock exams",
      icon: BookOpen,
      color: "secondary"
    },
    {
      title: "Personalized Learning",
      description: "Get customized study plans based on your current level and target score",
      icon: Target,
      color: "accent"
    },
    {
    ...
    },
    {
      ...
      description: "Choose from multiple batch timings that suit your availability",
      icon: Clock,
      color: "warning"
    },
    {
  ...
  const testimonials = [
    {
      ...
      image: "/student-1.jpg",
      quote: "STUDYSTREAK's methodology and expert guidance helped me achieve my dream score in just 2 months!"
    },
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-primary-100 mb-8 animate-fade-in-up delay-100">
              Join thousands of successful students who have achieved their dream scores with 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {statistics.map((stat, index) => (
              <div key={index} 
                ...
                <div className="w-16 h-16 mx-auto mb-4 bg-primary-100 rounded-2xl 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {guarantees.map((guarantee, index) => (
              <div key={index} 
                ...
                <span className="text-neutral-800 font-medium">{guarantee}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary-600 to-primary-800">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Join our next batch and take the first step towards achieving your target score.
          </p>
