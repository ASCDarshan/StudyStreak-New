  ...
  const blogPosts = [
    {
      ...
      excerpt: "Learn the essential strategies and techniques to excel in IELTS Writing Task 2. This comprehensive guide covers everything from understanding the question types to structuring your essay effectively.",
    ...
    },
    {
      ...
      excerpt: "A detailed comparison of GRE and GMAT to help you choose the right test for your graduate school journey. Understand the key differences, scoring systems, and university preferences.",
    ...
    },
    {
      ...
      excerpt: "Improve your TOEFL Speaking score with these proven strategies. Learn how to manage your time effectively and deliver confident, structured responses.",
            ...
            {categories.map(category => (
              <button
                ...
                className={`px-4 py-2 rounded-full whitespace-nowrap mr-2 transition-all 
                  duration-300 ${selectedCategory === category 
            ...
            <div className="relative z-10">
              <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="text-primary-100 mb-8">
                  Get the latest articles, study tips, and exam strategies delivered 
                  right to your inbox.
                </p>
